...
namespace NeuralAlgorithm.Controls
{
    /// <summary>
    /// AI-NN Base Controls Library - Chart Control
    /// </summary>
    ...
    public class Chart : System.Windows.Forms.Control
    {
        ...
        Hashtable dataSeriesTable = new Hashtable();
        ...
        protected override void OnPaint(PaintEventArgs args)
        {
            ...
            if (rangeY != null)
            {
                ...
                IDictionaryEnumerator en = dataSeriesTable.GetEnumerator();
                while (en.MoveNext())
                {
        ...
        public void AddDataSeries(string name, Color color, SeriesType type, int width, bool updateYRange)
        {
            ...
            // add to series table
            dataSeriesTable.Add(name, series);
        }
        ...
        {
            // get data series
            DataSeries series = (DataSeries)dataSeriesTable[name];
            // update data
            series.data = data;
